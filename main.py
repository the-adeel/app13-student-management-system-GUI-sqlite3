from PyQt6.QtWidgets import (QApplication, QLabel, QWidget, QGridLayout, QMainWindow, QTableWidget,
                             QTableWidgetItem, QDialog, QBoxLayout, QVBoxLayout, QLineEdit, QComboBox, QPushButton,
...
class EditDialog(QDialog):
    def __init__(self):
        ...
        insert_button.clicked.connect(self.update_data)
